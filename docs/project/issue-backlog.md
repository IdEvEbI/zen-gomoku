...
| M1.2f | （待开）                                               | **fix: 根真双契约收紧**      | 已强制真双 ≠ 可成活四双苗；j11 对局回归；见 [tang-seng-strength.md](../design/tang-seng-strength.md) §3.2 |
...
4. **下一刀建议**：开 **M1.2f 根真双契约收紧**（文档 [tang-seng-strength.md](../design/tang-seng-strength.md) §3.2 已写）；  
