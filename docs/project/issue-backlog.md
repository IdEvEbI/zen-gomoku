...
- **当前优先级**：~~VCF~~ → **VCT（#70）** → 学堂闯关（#74）→ 打谱+分析（#73）→  
...
| M1.2 | [#70](https://github.com/IdEvEbI/zen-gomoku/issues/70) | **feat: VCT 威胁搜索**       | 设计见 [vct.md](../design/vct.md)；野心 A；**仅唐僧**；根序：VCF/VCT 优先于软挡                  |
...
4. **下一刀建议**：按 [vct.md](../design/vct.md) 实现 [#70](https://github.com/IdEvEbI/zen-gomoku/issues/70)（仅唐僧）；  
