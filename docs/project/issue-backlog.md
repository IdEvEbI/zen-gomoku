...
> **AlphaZero 风格路线（2026-08-05）**：设计见 [alphazero-lite.md](../design/alphazero-lite.md)。已定：独立训练仓；**自由 + 禁手两套规则并存**；**两个模型各训各用**；先模仿唐僧再自对弈。R0 已建 Issue [#54](https://github.com/IdEvEbI/zen-gomoku/issues/54)。
